#ifndef _ENCRYPT_H
#define _ENCRYPT_H
const unsigned char cipherkey[16]={43,126,21,22,40,174,210,166,171,247,21,136,9,207,79,60};		//初始密钥
...
const unsigned char Polymatrix[4][4]={{2,3,1,1},{1,2,3,1},{1,1,2,3},{3,1,1,2}};//多项式矩阵
/********************加密函数***********************************/
